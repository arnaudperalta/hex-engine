...
class Board:
    ...
    def print_board(self):
        ...
        for i in range(len(self.board_state)):
            ...
            if i % self.LINE_LEN != 10 or i // 11 < 9:
                to_print += "  "
            else:
                to_print += " "
        to_print += "\033[34m11\n\033[31m                         "
        to_print += "A  B  C  D  E  F  G  H  I  J  K\033[0m\n"
        return to_print
...
def neighbors(cell: int):
    """
        Return an array of position where non empty cells
        are present around 'cell'
    """
